...
## Objective
Configure the desktop Ollama runtime and Codex, Claude Code, pi, and OpenCode to use it instead of LM Studio, with automatic startup and predictable model loading/unloading.
...
3. Configure Ollama for automatic restart, controlled model residency, and idle unloading.
...
- [x] Added controlled-residency/idle-unload Compose settings and removed LM Studio client providers.
